...
def test_calculate_metrics_returns_urban_metrics(
    solar_20x30: Solar, program_2_t2: Program
) -> None:
...
def test_calculate_metrics_coverage_bounded(
    solar_20x30: Solar, program_2_t2: Program
) -> None:
    solution = solve(solar_20x30, program_2_t2, timeout_seconds=30)
    building = build_building_from_solution(solar_20x30, program_2_t2, solution)
...
def test_calculate_metrics_density_positive(
    solar_20x30: Solar, program_2_t2: Program
) -> None:
    solution = solve(solar_20x30, program_2_t2, timeout_seconds=30)
    building = build_building_from_solution(solar_20x30, program_2_t2, solution)
