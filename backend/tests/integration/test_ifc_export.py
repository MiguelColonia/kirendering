...
class TestIfcExport:
    ...
    def test_ifc_contains_parking_spaces(self, parking_exported_ifc_path: Path) -> None:
        ...
        parking_spaces = [
            space for space in model.by_type("IfcSpace") if getattr(space, "PredefinedType", None) == "PARKING"
        ]
    ...
    def test_ifc_contains_parking_storey(self, parking_exported_ifc_path: Path) -> None:
        ...
        assert result.num_storeys >= 6, f"Se esperaban al menos 6 plantas IFC, hay {result.num_storeys}"
