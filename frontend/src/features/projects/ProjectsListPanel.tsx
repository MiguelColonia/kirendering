    ...
    <section className="panel-surface rounded-[2rem] p-6 md:p-8">
      <div className="flex flex-col gap-4 border-b border-[color:var(--color-line)] pb-5 md:flex-row md:items-end md:justify-between">
        <div className="space-y-2">
          <StatusBadge tone="accent">{t('projects.list.title')}</StatusBadge>
          <div>
            <h2 className="text-2xl font-semibold tracking-[-0.04em]">{t('projects.list.title')}</h2>
              ...
              <table className="min-w-full border-collapse text-left">
                ...
                <tbody>
                  {filteredProjects.map((project) => (
                    <tr key={project.id} className="border-t border-[color:var(--color-line)] align-top">
                      <td className="px-5 py-5">
                        <div className="space-y-2">
                          ...
                          <p className="max-w-md text-sm leading-6 text-[color:var(--color-mist)]">
                            {project.description || t('projects.table.empty_description')}
                          </p>
                        </div>
                      </td>
